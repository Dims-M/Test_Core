...
namespace Test
{
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Самый простой тип Middleware. После его работы он не передает зпрос далшьше в по конвееру. 
            //Он должен быть замыкающим. После его работы запрос должен ути пользователю
            //app.Run(async...);
